...
### **_NOTE:_** - This FAQ applies to Barcode Reader SDK version 9 or earlier. For the latest version, please refer to our latest version introduction [here\*](https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/).
